...
class ErrorCode implements OptionSourceInterface
{
    ...
    public function toOptionArray()
    {
        return [
            [
                ...
                'value' => $this->getSystemErrorsOptions(),
            ],
            [
                'label' => __('Timeout errors'),
                'value' => $this->getTimeoutErrorsOptions(),
            ],
            [
                'label' => __('Cash machine errors: Agent Errors'),
                'value' => $this->getCashMachineAgentErrorsOptions(),
            ],
            [
                'label' => __('Cash machine errors: Driver Errors'),
                'value' => $this->getCashMachineDriverErrorsOptions(),
            ],
            [
                'label' => __('Unknown Errors'),
                'value' => $this->getUnknownErrorsOptions(),
            ],
        ];
    }
     ...
     * @return array
     */
    private function getSystemErrorsOptions()
    {
        return [
     ...
     * @return array
     */
    private function getTimeoutErrorsOptions()
    {
        return [
     ...
     * @return array
     */
    private function getCashMachineAgentErrorsOptions()
    {
        return [
     ...
     * @return array
     */
    private function getCashMachineDriverErrorsOptions()
    {
        return [
     ...
     * @return array
     */
    private function getUnknownErrorsOptions()
    {
        return [
